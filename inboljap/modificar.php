<?php
	...
	$query="SELECT nombre,apellido_paterno,apellido_materno,ci,curso,direccion,telefono FROM alumno WHERE id='$id'";
...
<html>
	...
	<body>
		...
		<form name="modificar_usuario" method="POST" action="alumnoModificado.php">
			...
			<table width="50%">
				...
				<tr>
					<td><b>CURSO</b></td>
					<td><input type="text" name="cur" size="25" value="<?php echo $row['curso']; ?>" /></td>
				</tr>
